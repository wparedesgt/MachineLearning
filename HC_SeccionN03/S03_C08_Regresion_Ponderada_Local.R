...
#Comenzamos con una ventana de tres semanas y luego consideramos habilitar#S03_C08_Regresion_Ponderada_Local_loess
#Regresion Ponderada Local loess
...
polls_2008 %>% ggplot(aes(day, margin)) +
  geom_point() + 
  geom_smooth(color="red", span = 0.15, method.args = list(degree=1) otras opciones.
