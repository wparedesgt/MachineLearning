#S03_C08_Regresion_Ponderada_Local
#Regresion Ponderada Local

#Una limitación del enfoque de bin bin más suave que acabamos de describir es que necesitamos ventanas pequeñas para mantener el supuesto aproximadamente constante.
...
Hay otras tres diferencias entre loess y el bin bin suavizador típico que describimos aquí.
...
Es posible que haya notado que cuando mostramos el código para loess, establecemos un grado de parámetro igual a 1.
